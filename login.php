<?php
	...
	$smarty->display('default.tpl');
		// Meta bellow add by eggoez - http://eggoez.com because the login.php page has been posted or indexed by Google for more info please check reason this on http://eggoez.com/flatpress/search.php?q=login+php+noindex&stype=full
